...
describe('PersonaSelector', () => {
    ...
    describe('Rendering', () => {
        ...
        it('displays persona descriptions', () => {
            ...
            expect(
                screen.getByText('Relies on structured reasoning and evidence-based arguments.')
            ).toBeInTheDocument();
            expect(
                screen.getByText('Uses charisma and theatrical flair to captivate the audience.')
            ).toBeInTheDocument();
            expect(
                screen.getByText('Questions everything and challenges conventional wisdom.')
            ).toBeInTheDocument();
        });
    ...
    describe('User Interactions', () => {
        ...
        it('updates visual state when selection changes', () => {
            ...
            rerender(<PersonaSelector {...defaultProps} selectedPersona="showman" />);
    ...
    describe('Disabled State', () => {
        it('disables excluded persona', () => {
            render(<PersonaSelector {...defaultProps} excludePersona="contrarian" />);
    ...
    describe('Edge Cases', () => {
        it('handles empty persona list gracefully', () => {
            ...
            const EmptyPersonaSelector = (props: React.ComponentProps<typeof PersonaSelector>) => {
                // Mock empty data just for this component instance
                React.useMemo(() => {
                    // Mock empty data directly
                    const personas = require('@/lib/personas'); // eslint-disable-line @typescript-eslint/no-require-imports
                    jest.spyOn(personas, 'getPersonaEntries').mockReturnValueOnce([]);
                }, []);
